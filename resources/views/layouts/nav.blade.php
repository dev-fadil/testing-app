...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Admin SMP 1 Wringin</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Muhammad Fadil Hasan</a>
            </div>
        </div>
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="/fadil" class="nav-link {{ request()->is('fadil') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Fadil</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="/welcome" class="nav-link {{ request()->is('welcome') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Welcome</p>
                            </a>
                        </li>
